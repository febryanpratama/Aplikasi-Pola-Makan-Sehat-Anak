    ...
    <!-- Jumbotron -->
        ...
        <section class="bg-white dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
                ...
                <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Aplikasi Rekomendasi Makanan Sehat</h1>
                <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">Ini merupakan aplikasi yang digunakan untuk mencari rekomendasi makanan sehat untuk anak usia bayi dan balita di umur kurang dari 60 bulan atau 5 tahun.</p>
            ...
            <div class="py-8 mx-auto max-w-screen-xl lg:py-16">
                ...
                <div class="mb-8 flex justify-center">
                    <div class="text-center">
                        <h2 class="text-4xl font-bold text-gray-900 dark:text-white">Statistik</h2>
                ...
                <div class="rounded-lg dark:bg-gray-800">
                    <dl class="grid max-w-screen-xl grid-cols-1 gap-8 mx-auto text-gray-900 sm:grid-cols-1 xl:grid-cols-3 dark:text-white">
                        <div class="flex flex-col items-center justify-center bg-blue-100 py-4">
                            <dt class="mb-2 text-3xl font-extrabold">100</dt>
                            <dd class="text-gray-500 dark:text-gray-400">Anak</dd>
                        </div>
                        <div class="flex flex-col items-center justify-center bg-blue-100 py-4">
                            <dt class="mb-2 text-4xl font-extrabold">100</dt>
                            <dd class="text-gray-500 dark:text-gray-400">Kelompok Makanan</dd>
                        </div>
                        <div class="flex flex-col items-center justify-center bg-blue-100 py-4">
                            <dt class="mb-2 text-4xl font-extrabold">1000</dt>
                            <dd class="text-gray-500 dark:text-gray-400">Makanan</dd>
                        </div>
                    </dl>
                </div>
            </div>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="w-full mx-auto max-w-screen-xl py-12 md:items-center md:justify-between ">
                <div class="mb-8 flex justify-center">
                    <div class="text-center">
                        <h2 class="text-4xl font-bold text-gray-900 dark:text-white">Daftar Makanan</h2>
                        <p class="text-md text-gray-500 dark:text-gray-400">Box is a container component that can contain other elements and components.</p>
                    </div>
                </div>
                <div class="grid grid-rows w-full">
                    @foreach ($foods as $item)
                        <div class="w-full">
                            <a href="#" class="mt-6 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:w-full hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                ...
                <div class="py-12 flex justify-end">
                    <a href="{{ route('guest.food') }}" class="text-white end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Lihat Semua</a>
                </div>
            </div>
        </section>

        <!-- Box -->
        <section class="w-full mx-auto max-w-screen-xl py-12">
            {{-- Label --}}
            <div class="my-12">
                <h2 class="text-4xl font-bold text-gray-900 dark:text-white">Kontak</h2>
                <p class="text-md text-gray-500 dark:text-gray-400">Berikan saran dan pendapat anda pada website ini.</p>
            </div>
