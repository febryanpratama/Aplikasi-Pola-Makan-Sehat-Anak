<x-app-layout>
     ...
     <div class="py-12">
          <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 text-center">
               <a href="{{ route('admin.food_group.create') }}" class="inline-flex justify-between items-center py-1 px-1 pe-4 mb-7 text-sm text-blue-700 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-800">
               ...
               <form class="w-full mx-auto pt-6" action="{{ route('admin.food_group.search') }}" method="POST">   
                    @csrf
                    @method("POST")
                                                       ...
                                                       <div id="popup-modal-{{ $item->slug }}" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                            <div class="relative p-4 w-full max-w-md max-h-full">
                                                                 <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                                      ...
                                                                      <form action="{{ route('admin.food_group.destroy', [$item->slug] ) }}" method="post">
                                                                           @csrf
                                                                           @method('delete')
