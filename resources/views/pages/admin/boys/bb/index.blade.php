<x-app-layout>
     ...
     <div class="py-12">
          <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 text-center">
               <a href="{{ route('admin.boys.weight.create') }}" class="inline-flex justify-between items-center py-1 px-1 pe-4 mb-7 text-sm text-blue-700 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-800">
               ...
               <form class="w-full mx-auto pt-6" action="{{ route('admin.boys.weight.search') }}" method="POST">   
                    @csrf
                    @method("POST")
               ...
               <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                         <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                              ...
                              <tbody>
                                   @isset($standars)
                                        @foreach ($standars as $index => $item)
                                             <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                                  ...
                                                  <td class="px-6 py-4">
                                                       <div class="flex col-2 gap-2">
                                                            <div>
                                                                 <span>Minus 1 SD : </span>
                                                            </div>
                                                            <div>
                                                                 <span>{{ $item->minus_1_sd }}</span>
                                                            </div>

                                                            <div>
                                                                 <span>Minus 2 SD : </span>
                                                            </div>
                                                            <div>
                                                                 <span>{{ $item->minus_2_sd }}</span>
                                                            </div>

                                                            <div>
                                                                 <span>Minus 3 SD : </span>
                                                            </div>
                                                            <div>
                                                                 <span>{{ $item->minus_3_sd }}</span>
                                                            </div>
                                                       </div>
                                                  ...
                                                  <td class="px-6 py-4">
                                                       <div class="flex col-2 gap-2">
                                                            ...
                                                            <div>
                                                                 <span>{{ $item->standar_protein }}</span>
                                                            </div>
                                                       </div>
                                                       ...
                                                       <div class="flex col-2 gap-2">
                                                            ...
                                                            <div>
                                                                 <span>{{ $item->standar_carbohydrat }}</span>
                                                            </div>
                                                       </div>
                                                  </td>
                                                       ...
                                                       <div id="popup-modal-{{ $index }}" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                            <div class="relative p-4 w-full max-w-md max-h-full">
                                                                 <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                                      ...
                                                                      <form action="{{ route('admin.boys.weight.destroy', [$item->old] ) }}" method="post">
                                                                           @csrf
                                                                           @method('delete')
